...
// Bases
    ...
    swarm: { reload: 23, recoil: 0.25, shudder: 0.05, size: 0.4, damage: 1.2, speed: 4, spray: 5 },
...
// Drones
    ...
    satellite: { size: 0.8, reload: 3, damage: 4 },
...
// Heavy cannons
    ...
    destroyer: { reload: 2.2, recoil: 1.8, shudder: 0.5, health: 2, damage: 1.4, pen: 1.2, speed: 0.65, maxSpeed: 0.5, density: 2, resist: 3 },
    annihilator: { reload: 0.8, recoil: 1.25, damage: 1.43 },
...
// Misc
    ...
    rainmaker: { speed: 0.03, maxSpeed: 0.5, health: 0.98, damage: 0.88, range: 0.25 },
    acceltospeedoflight: { speed: 0.001, maxSpeed: 1000 },
    explosion: { speed: 0.01, maxSpeed: 0.01, health: 5, damage: 3, pen: 4.6, density: 3.6, resist: 3 },
    ...
    sidewinder2: { shudder: 0, spray: 0, size: 0.8, speed: 0.001, damage: 5 },
    repeater: { damage: 0.6 },
    vulc: {reload: 1.25, recoil: 0.1, shudder: 0, size: 0.8, health: 0.6, damage: 0.27, pen: 1, speed: 1.3, maxSpeed: 1.3, range: 1, density: 1.25, spray: 0.001, resist: 1.1},
}