...
class Gun extends EventEmitter {
    ...
    calculateBulletStats() {
        ...
        if (!this.ignorecanshootchecks && !this.canShoot) return;
    ...
    move() {
        ...
        switch (this.motionType) {
            ...
            case "chonk":
                ...
                break;
            case "accelerate":
                    this.velocity.x += 4.5 * Math.cos(this.facing)
                    this.velocity.y += 4.5 * Math.sin(this.facing)
                    this.topSpeed += 30;
                    this.maxSpeed += 30;
                    this.damp = -0.0125;
                    //this.damage += 0.45 for now...
                    break;
